...
public class MyCustomNotificationOpenedHandler implements OneSignal.NotificationOpenedHandler {

    Context ApplicationContext;

    public MyCustomNotificationOpenedHandler( Context ApplicationContext) {
